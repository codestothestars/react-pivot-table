...
/**
 * Registers the service worker with the specified configuration.
 *
 * @param config The service worker registration configuration.
 */
...
/**
 * Registers a valid service worker with the specified URL and configuration.
 *
...
/**
 * Checks whether the service worker with the specified URL and configuration is valid.
 *
 * @param swUrl The service worker URL.
 * @param config The service worker registration configuration.
 */
